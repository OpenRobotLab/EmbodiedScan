...
class APCalculator(object):
    ...
    def make_gt_list(self, gt_box_corners, gt_box_sem_cls_labels,
                     gt_box_present):
        batch_gt_map_cls = []
    ...
    def step(
        ...
        """Perform NMS on predicted boxes and threshold them according to
        score.
    ...
    def metrics_to_dict(self, overall_ret):
        ...
        for ap_iou_thresh in self.ap_iou_thresh:
            ...
            metrics_dict[
                f'AR_{ap_iou_thresh}'] = overall_ret[ap_iou_thresh]['AR'] * 100
        return metrics_dict
